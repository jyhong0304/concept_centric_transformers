...
DATA_NAME = 'ImageNetDatamodule'


def get_parser(parser):
    parser = ArgumentParser(description='ImageNet dataset without explanations',
    ...
    parser.add_argument('--expl_lambda', default=0., type=float,
                        help='weight of explanation loss')
    parser.add_argument('--num_workers', default=8, type=int, help='number of workers')
    parser.add_argument('--seed', default=1, type=int, help='random seed')
    parser.add_argument('--task', default='multiclass', type=str,
                        help='task type')
    parser.add_argument('--model', default='iamgenet_slotcvit', type=str,
                        help='model type')
