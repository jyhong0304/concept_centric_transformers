...
class CUB2011Parts_dataset(VisionDataset):
    ...
    attributes_to_retain = [2, 5, 7, 8, 11, 15, 16, 21, 22, 24, 25, 26, 30, 31, 36, 37, 39, 41, 45, 46, 51, 52, 54, 55,
                            57, 58, 60, 64, 70, 71, 73,
                            76, 81, 91, 92, 102, 105, 107, 111, 112, 117, 118, 120, 126, 127, 132, 133, 135, 146, 150,
                            152, 153, 154, 158, 159,
                            164, 165, 166, 169, 173, 179, 180, 183, 184, 188, 189, 194, 195, 197, 203, 204, 209, 210,
                            212, 219, 221, 222, 226,
                            228, 236, 237, 239, 241, 244, 245, 249, 250, 254, 255, 260, 261, 263, 269, 275, 278, 284,
                            290, 293, 294, 295, 299,
    ...
    def _load_metadata(self):
        ...
        present_attributes_global = present_attributes_candidate_parts[
            present_attributes_candidate_parts['part_id'] == 0]
        present_attributes_all = pd.concat([present_attributes_parts, present_attributes_global]).sort_values(
            by=['img_id', 'attr_id'])

        # Apply attribute filter
        present_attributes_all = present_attributes_all[
            present_attributes_all['attr_id'].isin(self.attributes_to_retain)]

        # Set type to int32 for id values
        self.present_attributes = present_attributes_all.astype(
            {'img_id': 'int32', 'attr_id': 'int32', 'part_id': 'int32'})
